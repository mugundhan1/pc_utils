...
//  /   /         Filename : clkgen.v
// /___/   /\     Timestamp : 08/01/2018 18:41:35
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: xaw2verilog -intstyle /home/mugundhan/mwa_digi_rec/spad_if_v1/ipcore_dir/clkgen.xaw -st clkgen.v
//Design Name: clkgen
...
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT0 = 0.126 ns
`timescale 1ns / 1ps

module clkgen(CLKIN_N_IN, 
              CLKIN_P_IN, 
              RST_IN, 
              CLKIN_IBUFGDS_OUT, 
              CLKOUT0_OUT, 
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(8.000), 
